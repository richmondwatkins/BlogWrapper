...
- (void)_initializeContent
{
    ...
    _likeButtonContainer = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 300, 300)];
    ...
    _socialSentenceLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 300, 300)];
    ...
    _likeBoxView = [[FBLikeBoxView alloc] initWithFrame:CGRectMake(0, 0, 300, 300)];
